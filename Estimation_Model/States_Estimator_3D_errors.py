...
ax1.set_title('Position error EML2O with 1 antenna ($\sigma$ = 385.6 m)')
ax1.set_xlim(0, 14)
...
ax2.set_title('Velocity error EML2O with 1 antenna ($\sigma$ = 385.6 m)')
ax2.set_xlim(0, 14)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error EML2O with 2 antenna ($\sigma$ = 96.6 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error EML2O with 2 antenna ($\sigma$ = 96.6 m)')
ax2.set_xlim(0, 14)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error EML2O with 4 antenna ($\sigma$ = 24.2 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error EML2O with 4 antenna ($\sigma$ = 24.2 m)')
ax2.set_xlim(0, 14)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error EML2O with 8 antenna ($\sigma$ = 6.07 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error EML2O with 8 antenna ($\sigma$ = 6.07 m)')
ax2.set_xlim(0, 14)
ax2.set_ylim(-0.006, 0.006)

#16 Antennas
fig5, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error EML2O with 16 antenna ($\sigma$ = 1.52 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error EML2O with 16 antenna ($\sigma$ = 1.52 m)')
ax2.set_xlim(0, 14)
ax2.set_ylim(-0.002, 0.002)

"""ELO plot"""
#1 Antenna
fig6, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error ELO with 1 antenna ($\sigma$ = 385.6 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error ELO with 1 antenna ($\sigma$ = 385.6 m)')
ax2.set_xlim(0, 14)
ax2.set_ylim(-25, 25)

#2 Antennas
fig7, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
#4 Antennas
fig8, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error ELO with 4 antenna ($\sigma$ = 24.2 m)')
ax1.set_xlim(0, 14)
ax1.set_ylim(-4000, 4000)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error ELO with 4 antenna ($\sigma$ = 24.2 m)')
ax2.set_xlim(0, 14)
ax2.set_ylim(-0.8, 0.8)


#8 Antennas
fig9, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error ELO with 4 antenna ($\sigma$ = 6.07 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error ELO with 4 antenna ($\sigma$ = 6.07 m)')
ax2.set_xlim(0, 14)
ax2.set_ylim(-0.4, 0.4)

#16 Antennas
fig10, (ax1, ax2) = plt.subplots(2, 1, constrained_layout=False, sharey=False)
...
ax1.set_xlabel('Time [days]')
ax1.set_ylabel('Position error [m]')
ax1.set_title('Position error ELO with 16 antenna ($\sigma$ = 1.52 m)')
ax1.set_xlim(0, 14)
...
ax2.set_xlabel('Time [days]')
ax2.set_ylabel('Velocity error [m/s]')
ax2.set_title('Velocity error ELO with 16 antenna ($\sigma$ = 1.52 m)')
ax2.set_xlim(0, 14)
