...
H_rho = [rho_par_x1, rho_par_y1, rho_par_z1, rho_par_vx1, rho_par_vy1, rho_par_vz1,
         rho_par_x2, rho_par_y2, rho_par_z2, rho_par_vx2, rho_par_vy2, rho_par_vz2]

H_rho_dot = [rho_dot_par_x1, rho_dot_par_y1, rho_dot_par_z1, rho_dot_par_vx1, rho_dot_par_vy1, rho_dot_par_vz1,
             rho_dot_par_x2, rho_dot_par_y2, rho_dot_par_z2, rho_dot_par_vx2, rho_dot_par_vy2, rho_dot_par_vz2]
print(H_rho, '\n', H_rho_dot)